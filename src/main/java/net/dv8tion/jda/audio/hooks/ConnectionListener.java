...
/**
 * Used to monitor an audio connection, ping, and speaking userIds.
...
public interface ConnectionListener
{
    ...
    /**
     * This method is an easy way to detect if a userId is talking. Discord sends us an event when a userId starts or stops
     * talking and it is parallel to the audio socket, so this event could come milliseconds before or after audio begins
     * or stops. This method is brilliant for clients wanting to display that a userId is currently talking.
     * <p>
     ...
     * <br>If the userId speaks for 3 minutes straight without ever stopping, then this would fire 2 times, once at the beginning
     ...
     * @param  speaking
     *         If true, the userId has begun transmitting audio.
     */
