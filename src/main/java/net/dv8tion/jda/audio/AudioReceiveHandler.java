...
public interface AudioReceiveHandler
{
     ...
     *
     * @return If true, JDA enables subsystems to combine all userId audio into a single provided data packet.
     */
     ...
     *
     * @return If true, JDA enables subsystems to provide userId specific audio data.
     */
     ...
     * during the 20 millisecond period mixed together into a single 20 millisecond packet. If no userIds spoke, this method
     * will still be provided with a CombinedAudio object containing 20 milliseconds of silence and
     * {@link CombinedAudio#getUserIds()}'s list will be empty.
     * <p>
     ...
     * <p>
     * If you are wanting to do audio processing (voice recognition) or you only want to deal with a single userId's audio,
     ...
     * object to this method <b>every time the userId speaks.</b> Continuing with the last statement: This method is only fired
     ...
     * {@link net.dv8tion.jda.core.entities.User User} that spoke along with <b>only</b> the audio data sent by the specific userId.
     * <p>
     * The main use of this method is for listening to specific userIds. Whether that is for audio recording,
     * custom mixing (possibly for userId muting), or even voice recognition, this is the method you will want.
     * <p>
