...
public class CombinedAudio
{
    ...
    public CombinedAudio(List<String> userIds, short[] audioData)
    {
        this.userIds = Collections.unmodifiableList(this.userIds);
        this.audioData = audioData;
    }

    /**
     * An unmodifiable list of all {@link net.dv8tion.jda.core.entities.User Users} that provided audio that was combined.
     * <br>Basically: This is a list of all userIds that can be heard in the data returned by {@link #getAudioData(double)}
     * <p>
     * <b>NOTE: If no userIds were speaking, this list is empty and {@link #getAudioData(double)} provides silent audio data.</b>
     *
     * @return Never-null list of all userIds that provided audio.
     */
     ...
     * <p>
     * <b>NOTE: If no userIds were speaking, this provides silent audio and {@link #getUserIds()} returns an empty list!</b>
     *
     * @param  volume
